...
#define PROPULSION_FORCE Vector3(0.0f, 163.0f, 0.0f)
#define PROPULSION_END2_FORCE Vector3(0.0f, 120.0f, 0.0f)
#define WINDOW_POSITION Vector3(0.0f, 0.0f, -3.0f)
#define WATER_PLANE_POSITION Vector3(0.0f, 2000.0, 0.0f)
#define SPACECRAFT_END_POSITION Vector3(0.0f, 900.0f, 0.0f)
#define SPACECRAFT_END2_POSITION CAMERA_FINAL_POSITION + Vector3(0.0f, -70.0f, 100.0f)
#define SPACECRAFT_END3_POSITION WATER_PLANE_POSITION + Vector3(0.0f, 80.0f, 0.0f)
#define SPHERE_END2_POSITION CAMERA_FINAL_POSITION + Vector3(0.0f, 0.0f, 100.0f)
#define SPHERE_END3_POSITION SPACECRAFT_END3_POSITION + Vector3(0.0f, 100.0f, 0.0f)
